...
- Do not perform rape, erotic, mutilation, or any other extreme roleplay variation. In addition, do not perform detailed acts of torture, dismemberment, cannibalism, or other highly graphic activities.
...
## Account & Donations
  - ### Accounts & Characters
    ...
    - Serial Killers/Robots/Paranormal Characters, etc.. must be approved by the staff team via a Discord ticket. This soft-whitelist is in place to ensure quality roleplay, and to improve pacing with these types of storylines. This does not apply to normal shootings, kidnappings etc, but is specific to serial killer characters who go after locals, or regular players.
...
## Roleplay Rules
  - ### Quality
    ...
    - ### LQRP/FRP Examples
      ...
      - Dropping items while being cuffed/arrested
      - Robbing someone without reason or sufficient roleplay ( Broad daylight while others are around )
      - Using the same shootout location in a short amount of time
      - Failing to respond to `/me`, `/do`, `/says` interactions of other players, such as `/me takes off mask` or `/me steals shoes`
      - Actions that are unrealistic or hurt the roleplay experience of others players are considered as fail roleplay, however, not all actions that may seem unrealistic or punishable
      - Taking an enemy vehicle and stripping the upgrades off of it to scam someone
      - Talking normally after you have any type of inflicted wound. You should be screaming in pain for example if you get shot.
  ...
  - ### Character Customization
    ...
    - Do not play as a vigilante. You cannot be Batman, Spider-Man, John Wick, Jason Bourne, Daredevil, etc.
  - ### New Life Rule (NLR)
  ...
  - ### Deathmatching (RDM/VDM)
   ...
   - ### Metagaming, Powergaming, Torture RP
     ...
     - Do not chain rob stores, banks, ATMs, or any other property and device.
     - Do not elude police on a motorcycle or off-road unless agreed upon by all parties.
     - Do not drive off-road only vehicles on paved roadways unless driving to park at a nearby garage after purchase. Do not drive drag vehicles on the road, without expecting them to be auctioned off by the police.
